 ...
 */
public class UseByDefaultFilter extends BaseTest {

    @Test(groups = { "good" })

    public void UseByDefaultFilter() throws InterruptedException, IOException
    {
        ...
        wait(seconds);
        companyPage.UseByDefaultFilter(driver);
        wait(seconds);
