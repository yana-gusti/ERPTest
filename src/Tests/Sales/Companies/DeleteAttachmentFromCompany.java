 ...
 */
public class DeleteAttachmentFromCompany extends BaseTest {

    @Test(groups = { "good" })

    public void DeleteAttachmentFromCompany() throws InterruptedException, IOException
    {
        ...
        wait(seconds);
        companyPage.removeAttachFileToLead(driver);
        wait(seconds);
