 ...
 */
public class AttachFileToOpportunity extends BaseTest {

    @Test(groups = { "good" })

    public void AttachFileToOpportunity() throws InterruptedException, IOException
    {
        ...
        wait(seconds);
        opportunityPage.attachFileToLead(driver);
        wait(seconds);
