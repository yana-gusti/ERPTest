 ...
 */
public class NextPreviousPageTest extends BaseTest {

    @Test(groups = {"good"})

    public void NextPreviousPageTest() throws InterruptedException, IOException {
        PersonsPage personsPage = GoToPersonsPage();
        wait(seconds);
        OpportunitiesPage opportunityPage = personsPage.switchToOpportunities(driver);
        opportunityPage.SwitchToListView(driver);
        wait(seconds);
        opportunityPage.nextPreviousPageTesting(driver);
        wait(seconds);
    }
}