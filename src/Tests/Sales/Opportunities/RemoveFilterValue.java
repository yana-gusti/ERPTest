 ...
 */
public class RemoveFilterValue extends BaseTest {

    @Test(groups = { "good" })

    public void RemoveFilterValue() throws InterruptedException, IOException
    {
        ...
        wait(seconds);
        opportunityPage.removeFilterValueFilter(driver);
        wait(seconds);
    }
}