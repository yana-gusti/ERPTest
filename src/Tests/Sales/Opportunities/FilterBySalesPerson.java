 ...
 */
public class FilterBySalesPerson extends BaseTest {

    @Test(groups = { "good" })

    public void FilterBySalesPerson() throws InterruptedException, IOException
    {
        ...
        wait(seconds);
        opportunityPage.filterBySales(driver);
        wait(seconds);
    }
}